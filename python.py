...
Question_Data_Leap = dynamodb.Table('Question_Data_Leap')
...
def lambda_handler(event, context):
    ...
    if avatar['type']=="WELCOME":
        ...
        if len(event['fm-question'])==0:
            ...
            if True:
                url="http://44.224.32.99:5002/webhooks/rest/webhook"
                random_number  =random.randint(0,len(data)-1)
                data1=data[random_number]['text']
